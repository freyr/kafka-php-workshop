...
#[AsCommand(
    name: 'offsets:produce',
    description: 'Produce payment-completed events to the offsets topic.',
)]
final class ProducePaymentEventsCommand extends Command
{
    ...
    {
        $this->addOption('count', 'c', InputOption::VALUE_REQUIRED, 'Number of messages to produce', 10);
    }
