 ...
 * and run-loop never change. Value-only on purpose: the message key (aggregate_id)
 * is the producer's concern, not the serializer's, so AVRO never leaks into the
 * base contract.
 */
